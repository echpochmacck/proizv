...
class Post extends Data
{
    ...
    public function pages(int $limit, int $offset, string|bool $pageOf = ''): array|bool
    {
        $text = ' SELECT count(*) '
            . 'FROM post';
    ...
    public function deletePost(string $user_id, bool $isAdmin, string $id): bool
    {
        ...
        if ($check = $this->user->mysql->querry($textt)) {
            ...
            if (!$isAdmin && ($user_id === $check[0]['user_id'])) {
